...
const events = [
  ...
  },
  {
    ...
    "id": "2",
    "image": alphaByte,
    "aboutEvent": "AlphaByte 1.0 is a National Level Hackathon organized by GDSC x Anantya 2024, in collaboration with the Computer Engineering Students Association (CESA). It is a flagship event of Anantya 2024, aimed at bringing together the brightest minds in the field of technology from across the country.",
  ...
  },
  {
    ...
    "id": "7",
    "image": mindMatrix,
    "aboutEvent": "Mind Matrix, an exhilarating intellectual journey that transcends conventional boundaries! It offers a unique blend of technical challenges infused with fun and excitement. With three distinct rounds meticulously detailed within, participants can expect their technical prowess to be thoroughly tested in an engaging and enjoyable manner.",
    
    "schedule": {
      "round1": [{ "date": "19th March", "time": "11:00 AM - 12:00 PM", "venue": " 6101, 6102, 6103" }],
      "round2": [{ "date": "20th March", "time": "11:00 AM - 12:00 PM", "venue": "6103" }],
  ...
  
  {
    ...
    "aboutEvent": "The competition offers teams a platform to showcase their research projects or ideas via concise and visually captivating posters. Participants are encouraged to utilize graphics, images, and succinct text to convey the core aspects of their research or project effectively. Emphasizing the importance of communicating to a diverse audience, achieving a balance between visual appeal and informative content is key. Best of luck to all participants in the competition!",
    "schedule": {
  ...
  },
  {
    ...
    "id": "11",
    "image": byteMe,
    "aboutEvent": "Byte Me is a fusion of challenges, testing individuals skills in a variety of domains,from exploring your general technical skills to cracking ciphers. Each challenge will be based on the key events on the story line movie interstellar,letting you explore the universe of computer science.",
    "schedule": {
